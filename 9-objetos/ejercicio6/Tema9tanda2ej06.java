...
public class Tema9tanda2ej06 {

  public static void main(String[] args) {
    Scanner s = new Scanner(System.in);

    Tiempo t1 = new Tiempo(1, 20, 30);
    Tiempo t2 = new Tiempo(2, 40, 10);
    Tiempo t3 = new Tiempo(0, 50, 40);

    System.out.println("Vamos a calcular sumas y restas de tiempos:");
    System.out.println(t1 + " + " + t3 + " = " + t1.suma(t3));
    System.out.println(t3 + " + " + t2 + " = " + t3.suma(t2));
